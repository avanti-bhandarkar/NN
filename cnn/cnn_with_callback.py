...
#fitting model
history=model.fit(x_tr, label_tr, batch_size=128, epochs=8, validation_split=.5)
...
#x_te=np.load("/content/drive/My Drive/imagesnum")
#x_te = x_te.reshape(20,28,28,1)
#label_telin=np.load("/content/drive/My Drive/labelsnum")
