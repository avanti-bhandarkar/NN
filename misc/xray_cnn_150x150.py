...
images=np.load("images_med")
labels=np.load("labels_med")
...
x_tr = x_tr.reshape(1003,150,150,1)
x_te = x_te.reshape(669,150,150,1)
...
#create model
model = Sequential()
model.add(Conv2D(64, kernel_size=3, activation='relu', input_shape=(150,150,1)))
...
plt.imshow(x_te2[index].reshape(150,150),cmap='Greys')
