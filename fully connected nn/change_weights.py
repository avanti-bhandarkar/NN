...
#creating model
model = Sequential()
model.add(Dense(128, activation='sigmoid', input_shape=(n,),kernel_initializer='random_normal', bias_initializer='zeros')) # changed from Xavier initialization to Random Normal initialization, accuracy lowered
